                        ...
                        <div class="card-body">
                            <form action=" {{ route('employee.attend.store') }}" method="post" id="myForm">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" name="date" id="date" class="checkdate form-control form-control-sm singledatepicker @error('date') is-invalid @enderror " placeholder="Attendance Date" autocomplete="off" value="{{ date('Y-m-d') }}" max="{{date('Y-m-d')}}">
                                    @error('date')
                                ...
                                <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                                    ...
                                    @foreach ($employees as $key => $employee)
                                        <tr id="div {{$employee->id}}" class="text-center">
                                            ...
                                            <td><img src="{{ asset($employee->image) }}" style="width: 50px;height: 30px"></td>
