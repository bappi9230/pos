                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <a href="{{ route('daily.expense') }}" class="btn btn-success rounded-pill waves-effect waves-light">Back</a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="post" action="{{ route('update.expense') }}" enctype="multipart/form-data">
                                    @csrf
