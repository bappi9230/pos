                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4 mb-1">
                                <div class="text-end d-print-none">
                                    ...
                                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#signup-modal">Create Invoice </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mt-2 mb-4 ">
                        <div class="auth-logo">
                            <h3>Invoice Of <span class="text-primary">{{ $customer->name }}</span></h3>
                            <h3>Total Amount <span class="text-primary"> {{ Cart::total() }}</span> </h3>
                        </div>
                    </div>
