                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <a href="{{ route('pending.order') }}" class="btn btn-primary rounded-pill waves-effect waves-light">Back </a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="post" action="{{ route('order.status') }}" enctype="multipart/form-data">
                                    @csrf
