                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form id="myForm" method="post" action="{{ route('update.role.permission',$role->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <label for="firstname" class="form-label">Account Roles And Permission</label>
                                                <h4> {{ $role->name }}</h4>
                                        ...
                                        @foreach($permission_groups as $key => $group)
                                            <div class="row">
                                                <div class="col-3">
                                                    ...
                                                    <div class="form-check mb-2 form-check-primary">
                                                        <input class="form-check-input" type="checkbox" value="" id="customckeck{{$key}}" {{ App\Models\User::hasPermission($role,$permission_groupby_name) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-9">
                                                    @foreach($permission_groupby_name as $name)
                                                        <div class="form-check mb-2 form-check-primary">
                                                            <input class="form-check-input" type="checkbox" name="permission[]" {{ App\Models\User::hasGroupByNamePermission($role,$name) ? 'checked':'' }} value="{{ $name->id }}" id="customckeck2{{$name->id}}">
