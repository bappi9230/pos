                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form method="post" action="{{ route('update.product',$product->id) }}" enctype="multipart/form-data" id="myForm">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="product_code" class="form-control " readonly value="{{$product->product_code}}" >
