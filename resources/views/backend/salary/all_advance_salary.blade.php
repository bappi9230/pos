                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                @foreach($advance_salary as $key=> $item)
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('edit.advance.salary',$item->id) }}" class="btn btn-info sm" title="Edit" ><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('advance.salary.delete',$item->id) }}" class="btn btn-danger sm" title="Delete" id="delete" ><i class="fa fa-trash" ></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
